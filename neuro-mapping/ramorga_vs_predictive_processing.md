...
A structural comparison of individual inference and relational emergence
...
subgraph PP[Predictive Processing]
    P1[Priors] --> PE[Prediction Error]
    PE --> PW[Precision Weighting]
    PW --> P1
end
